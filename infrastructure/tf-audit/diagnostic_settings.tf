locals {
  #APPSERVICEPLAN
  monitor_diagnostic_setting_appserviceplan_metrics = ["Basic", "InstanceAndAppAdvanced", "WorkloadManagement"]

  #FUNCTIONAPP
  monitor_diagnostic_setting_function_app_enabled_logs = ["AppServiceAuthenticationLogs", "FunctionAppLogs"]
  monitor_diagnostic_setting_function_app_metrics      = ["Basic", "InstanceAndAppAdvanced", "WorkloadManagement"]

  # KEYVAULT
  monitor_diagnostic_setting_keyvault_enabled_logs = ["AuditEvent", "AzurePolicyEvaluationDetails"]
  monitor_diagnostic_setting_keyvault_metrics      = ["Basic", "InstanceAndAppAdvanced", "WorkloadManagement"]

  # LOG ANALYTICS WORKSPACE
  monitor_diagnostic_setting_log_analytics_workspace_enabled_logs = ["SummaryLogs", "Audit"]
  monitor_diagnostic_setting_log_analytics_workspace_metrics      = ["Basic", "InstanceAndAppAdvanced", "WorkloadManagement"]
  ...
  monitor_diagnostic_setting_vnet_metrics      = ["Basic", "InstanceAndAppAdvanced", "WorkloadManagement"]
}
