...
locals {
  ...
  # event_grids = {
  #   for event_grid_key, event_grid_details in var.event_grid_subscriptions :
  ...
  event_grid_config_object_list = flatten([
    for region in keys(var.regions) : [
      for event_grid_subscription_key, event_grid_subscription_details in var.event_grid_subscriptions : merge(
        {
