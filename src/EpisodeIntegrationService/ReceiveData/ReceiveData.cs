...
public class ReceiveData
{
    ...
    public ReceiveData(ILogger<ReceiveData> logger, IHttpRequestService httpRequestService, IEndCodeLkpRepository endCodeLkpRepository, IEpisodeTypeLkpRepository episodeTypeLkpRepository, IOrganisationLkpRepository organisationLkpRepository)
    {
        _logger = logger;
