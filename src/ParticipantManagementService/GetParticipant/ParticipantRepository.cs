...
namespace GetParticipant
{
    public static class ParticipantRepository
    {
        private static readonly List<Participant> Participants = new List<Participant>
        {
            ...
            new Participant { nhs_number = "1111111112", next_test_due_date = "null", gp_practice_id = "39", subject_status_code = "NORMAL",
                            is_higher_risk = "false", higher_risk_next_test_due_date = "null", removal_reason = "null", removal_date = "null",
                            bso_organisation_id = "null", early_recall_date = "null", latest_invitation_date = "null", preferred_language = "null",
            ...
            new Participant { nhs_number = "1111111110", next_test_due_date = "null", gp_practice_id = "null", subject_status_code = "NORMAL",
