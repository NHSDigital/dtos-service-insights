...
1. **Update git submodules**
   The src/Shared/dotnet-mesh-client folder needs to be populated if you just cloned the repo.
   Run this command in the root of the repo, you only need to do this once.
