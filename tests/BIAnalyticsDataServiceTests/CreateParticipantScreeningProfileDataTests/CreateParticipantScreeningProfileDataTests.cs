...
public class CreateParticipantScreeningProfileDataTests
{
    ...
    private readonly ParticipantScreeningProfile ValidParticipantScreeningProfile = new ParticipantScreeningProfile()
    {
        ...
        ReasonForRemovalDt = new DateOnly(2019, 08, 01),
        NextTestDueDate = new DateOnly(2019, 08, 01),
        NextTestDueDateCalcMethod = "TestCalculationMethod",
        ...
        HigherRiskNextTestDueDate = new DateOnly(2019, 08, 01),
        HigherRiskReferralReasonCode = "reason",
        HrReasonCodeDescription = "TestHrReasonCodeDescription",
        DateIrradiated = new DateOnly(2019, 08, 01),
        GeneCode = "123456789",
